...
public class MapControls : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityInputHandler<Vector2>
{
    // Start is called before the first frame update    private const double JoystickDeadZone = 0.3;

    private const double JoystickDeadZone = 0.3;
    private MapRenderer _mapRenderer;
    // private MapRenderer _hostRenderer;
    ...
    private Transform hostTransform = null;
        ...
        [SerializeField]
    [Tooltip("Transform that will be dragged. Defaults to the object of the component.")]
    private MapRenderer _hostRenderer = null;
    ...
    public MapRenderer HostRenderer
    {
        get => _hostRenderer;
        set => _hostRenderer = value;
    }
    ...
    private void Update()
    {
            ...
            CoreServices.InputSystem.FocusProvider.TryGetFocusDetails(_panningPointer, out FocusDetails focusDetails))
        {
            ...
            if (directionalZoomAmount != 0)
            {
                ...
                _hostRenderer.ZoomLevel = zoomLevelToUseForInteraction;
            ...
            _hostRenderer.Center = _mapRenderer.Center;
        }
    }
